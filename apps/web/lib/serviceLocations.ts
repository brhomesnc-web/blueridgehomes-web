...
export const serviceLocations: ServiceLocation[] = [
  ...
  // ---------------------------------------------------------------- 4
  {
    ...
    // unincorporated-North-Buncombe binary in this paragraph is correct for this
    // entry’s anchor project. Note the custom-homes/weaverville entry is NOT a binary
    // — Settlers Cove is Madison County — so do not copy this paragraph across.
    localDetail:
